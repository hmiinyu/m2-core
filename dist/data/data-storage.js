...
var _store_core = function _store_core(storageType) {
  ...
  return {
    ...
    encrypt: function encrypt(data) {
      ...
      return secret ? _dataSecurity.DataSecurity.encrypt(data, encryptType, encryptParams) : data;
    },
    decrypt: function decrypt(data) {
      var secret = arguments.length > 1 && arguments[1] !== undefined ? arguments[1] : false;
      return secret ? _dataSecurity.DataSecurity.decrypt(data, encryptType, encryptParams) : data;
    }
  };
};
...
function () {
  ...
  _createClass(DataStorage, null, [{
    ...
    value: function get(key) {
      ...
      var _DEFAULT_STORAGE_OPTI = _objectSpread({}, _constants.DEFAULT_STORAGE_OPTIONS, {}, options),
    ...
    value: function set(key, value) {
      ...
      var _DEFAULT_STORAGE_OPTI2 = _objectSpread({}, _constants.DEFAULT_STORAGE_OPTIONS, {}, options),
