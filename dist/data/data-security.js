...
var _crypto_core = function () {
  ...
  Object.keys(_constants.ASYMMETRIC_CRYPTO_TYPE).forEach(function (prop) {
    ...
    if (_item.name) {
      ...
      if (_item.hmac) {
        context[_item.name] = _objectSpread({}, context[prop], {
  ...
  Object.keys(_constants.SYMMETRIC_CRYPTO_TYPE).forEach(function (prop) {
    ...
    if (_item.name) {
      ...
      if (_item.encoding) {
        context[_item.name] = _objectSpread({}, context[_item.name], {
          encrypt: function encrypt(data) {
        ...
        var _iv = _dataType.DataType.defaultVal(_item.iv, true);
...
function () {
  function DataSecurity() {
    _classCallCheck(this, DataSecurity);
  }

  _createClass(DataSecurity, null, [{
    key: "encrypt",
