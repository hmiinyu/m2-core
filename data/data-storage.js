...
const _store_core = (storageType, encryptType = '') => {
  ...
  return {
    ...
    encrypt: (data, secret = false) => secret ? DataSecurity.encrypt(data, encryptType, encryptParams) : data,
    decrypt: (data, secret = false) => secret ? DataSecurity.decrypt(data, encryptType, encryptParams) : data,
  };
};
